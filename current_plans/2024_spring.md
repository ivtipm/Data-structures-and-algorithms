...
## Лекция 10. Очереди (продолжение)
17 апреля
1. Повторение. Очередь vs Stack. Кольцелой буффер. Поразрядная сортировка.
...
## Лекция 11. Строки. Алгоритмы поиска в строках.
...
2. Напишите тесты
3. Измерьте среднее время работы алгоритма на данных:
    - случайные последовательности,
    - поиск слов в тексте на естественном языке,
    - случайные последовательености из алфавита A,C,G,T
