...
## Лекция 8. Структуры данных. Списки (продолжение). Поисковые структуры данных. 
27 марта
1. Повторене. Бинарный поиск. Алгоритмы сортировки. Список (обход, добавление в ..., удаление из ..., поиск).
2. Поисковые структуры данных: сортированный массив, сортированный список.
